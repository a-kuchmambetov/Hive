...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-08-25 10:09:27 by akuchmam          #+#    #+#             */
/*   Updated: 2025-08-25 10:09:27 by akuchmam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const int	new_y = game->level.p_pos[0] + dy;
	const int	new_x = game->level.p_pos[1] + dx;
	...
	if (game->map.data[new_y][new_x] == 'E'
		&& game->level.collected_count == game->level.total_collectibles)
		close_game(game);
